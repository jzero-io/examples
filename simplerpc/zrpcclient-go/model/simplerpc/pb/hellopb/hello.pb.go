...
const file_v1_hello_proto_rawDesc = "" +
	"\n" +
	"\x0ev1/hello.proto\x12\ahellopb\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\"0\n" +
	"\n" +
	"SayRequest\x12\"\n" +
	...
	"\x05Hello\x122\n" +
	"\x03Say\x12\x13.hellopb.SayRequest\x1a\x14.hellopb.SayResponse\"\x00B\x0eZ\f./pb/hellopbb\x06proto3"

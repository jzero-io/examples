...
const file_v1_version_proto_rawDesc = "" +
	"\n" +
	"\x10v1/version.proto\x12\tversionpb\"\f\n" +
	"\n" +
	"GetRequest\"u\n" +
	...
	"\x06string\x18\x04 \x01(\tR\x06string2A\n" +
	"\aVersion\x126\n" +
	"\x03Say\x12\x15.versionpb.GetRequest\x1a\x16.versionpb.GetResponse\"\x00B\x10Z\x0e./pb/versionpbb\x06proto3"
